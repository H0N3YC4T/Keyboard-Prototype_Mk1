...
enum current_theme = NICE_VIEW_THEME_TRANSMUTATION;
#endif

#if IS_ENABLED(CONFIG_NICE_VIEW_ANIMATION_THEME_OMNISSIAH)
enum current_theme = NICE_VIEW_THEME_OMNISSIAH;
#endif

#if IS_ENABLED(CONFIG_NICE_VIEW_ANIMATION_THEME_ULTRAMAR)
enum current_theme = NICE_VIEW_THEME_ULTRAMAR;
#endif

#if IS_ENABLED(CONFIG_NICE_VIEW_ANIMATION_THEME_CRYSTAL)
enum current_theme = NICE_VIEW_THEME_CRYSTAL;
#endif
